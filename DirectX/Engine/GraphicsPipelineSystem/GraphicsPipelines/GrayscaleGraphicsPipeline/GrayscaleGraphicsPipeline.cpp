#include "GrayscaleGraphicsPipeline.h"
#include "Engine/Base/DebugLog/DebugLog.h"
#include <cassert>

GrayscaleGraphicsPipeline::GrayscaleGraphicsPipeline()
{
	Initialize();
}

void GrayscaleGraphicsPipeline::InitializePSO()
{
	//DescriptorRange
	...
	pixelShaderBlob_ = CompileShader(L"Resources/Shaders/GraphicsShaders/GrayscaleShader/Grayscale.PS.hlsl", L"ps_6_0", dxcUtils_.Get(), dxcCompiler_.Get(), includeHandler_.Get());
