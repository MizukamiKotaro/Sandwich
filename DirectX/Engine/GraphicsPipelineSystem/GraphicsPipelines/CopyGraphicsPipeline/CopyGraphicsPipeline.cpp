#include "CopyGraphicsPipeline.h"
#include "Engine/Base/DebugLog/DebugLog.h"
#include <cassert>

CopyGraphicsPipeline::CopyGraphicsPipeline()
{
	Initialize();
}

void CopyGraphicsPipeline::InitializePSO()
{
	//DescriptorRange
	...
	pixelShaderBlob_ = CompileShader(L"Resources/Shaders/GraphicsShaders/BasePostEffectShader/BasePostEffect.PS.hlsl", L"ps_6_0", dxcUtils_.Get(), dxcCompiler_.Get(), includeHandler_.Get());
