...
void ResultUI::Create()
{
	...
	textures_.resize(8);
	textures_[SpriteNameEnum::kRestart] = texMa->LoadTexture("restartUi.png");
	textures_[SpriteNameEnum::kRestart + 1] = texMa->LoadTexture("notRestartUi.png");
	textures_[SpriteNameEnum::kTitle] = texMa->LoadTexture("titleUi.png");
	textures_[SpriteNameEnum::kTitle + 1] = texMa->LoadTexture("notTitleUi.png");
	textures_[SpriteNameEnum::kResult] = texMa->LoadTexture("gameClear.png");
	textures_[SpriteNameEnum::kResult + 1] = texMa->LoadTexture("gameOver.png");
	textures_[SpriteNameEnum::kContinue] = texMa->LoadTexture("continueUi.png");
	textures_[SpriteNameEnum::kContinue + 1] = texMa->LoadTexture("notContinueUi.png");
